...
SECRET_KEY = 'django-insecure-!g5iuraocll!s4g65tzyp2*l96prn5uer3etve5xo5km%dcqg2'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'post_table',  # название вашей базы данных
        'USER': 'Anton',        # ваше имя пользователя
        'PASSWORD': 'VikaPidosha00!',    # ваш пароль
